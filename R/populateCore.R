...
#'
#' @examples 
#' lc.populate.core(dict_version = '2_0', cohort_id = 'dnbc', data_version = '1_0')
#'
#' @export
lc.populate.core <- local(function(dict_version = '2_0', cohort_id, data_version, database_name = 'opal_data') {
  message('######################################################')
