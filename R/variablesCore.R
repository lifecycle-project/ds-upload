...
lc.variables.core.yearly.repeated <- local(function() {
  return(c("cohab_0", "cohab_1", "cohab_2", "cohab_3", "cohab_4", "cohab_5", "cohab_6", "cohab_7", "cohab_8", "cohab_9", "cohab_10", "cohab_11", 
           ...
           "no2_y", "nox_y", "pm10_y", "pm25_y", "pmcoarse_y", "pm25abs_y", "pm25cu_y", "pm25fe_y", "pm25k_y", "pm25ni_y", "pm25s_y", "pm25si_y", 
           "pm25v_y", "pm25zn_y", "pm10cu_y", "pm10fe_y", "pm10k_y", "pm10ni_y", "pm10s_y", "pm10si_y", "pm10v_y", "pm10zn_y", "popdens_y", "bdens100_y", 
           "bdens300_y", "connind100_y", "connind300_y", "bus_lines_100_y", "bus_lines_300_y", "bus_lines_500_y", "bus_stops_100_y", "bus_stops_300_y", "bus_stops_500_y", "fdensity300_y", "frichness300_y", "landuseshan300_y", 
           "walkability_mean_y", "agrgr_y", "airpt_y", "hdres_y", "indtr_y", "ldres_y", "natgr_y", "other_y", "port_y", "trans_y", "urbgr_y", "vldres_y", 
           "water_y", "blue_dist_y", "green_dist_y", "blue_size_y", "green_size_y", "blueyn300_y", "greenyn300_y", "ndvi100_y", "ndvi300_y", "ndvi500_y", "lden_y", "ln_y", 
           "lden_c_y", "ln_c_y", "noise_dist_y", "areases_tert_y", "areases_quint_y", "distinvnear6_y", "trafload100_y", "trafmajorload100_y", "trafnear_y", "foodenvdens300_y", "foodenvdensosm300_y", "tm_y", 
           "tmin_y", "tmax_y", "hum_y", "hmin_y", "hmax_y", "uvddc_y", "uvdec_y", "uvdvc_y", "lst_y" ))
})
