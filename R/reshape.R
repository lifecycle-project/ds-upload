...
#'
#' @keywords internal
du.reshape.generate.non.repeated <- local(function(lc_data, upload,
...
#'
#' @keywords internal
du.reshape.generate.yearly.repeated <- local(function(lc_data, upload,
                                                      file_prefix, dict_kind, file_version, file_name) {
  ...
  write_csv(long_yearly, paste(getwd(), "/", file_prefix, "_", dict_kind, "_",
    file_version, "_", file_name, ".csv",
    sep = ""
  ), na = "")
...
#'
#' @keywords internal
du.reshape.generate.monthly.repeated <- local(function(lc_data, upload,
                                                       file_prefix, dict_kind, file_version, file_name) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
  ...
  write_csv(long_monthly, paste(getwd(), "/", file_prefix, "_", dict_kind, "_",
    file_version, "_", file_name, ".csv",
    sep = ""
  ), na = "")
...
#'
#' @keywords internal
du.reshape.generate.weekly.repeated <- local(function(lc_data, upload,
                                                      file_prefix, dict_kind, file_version, file_name) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
  ...
  write_csv(long_weekly, paste(getwd(), "/", file_prefix, "_", dict_kind, "_",
    file_version, "_", file_name, ".csv",
    sep = ""
  ), na = "")
...
#'
#' @keywords internal
du.reshape.generate.trimesterly.repeated <- local(function(lc_data, upload,
                                                           file_prefix, dict_kind, file_version, file_name) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
  ...
  lc_variables_trimesterly_repeated_dict <- du.retrieve.dictionaries(
    "trimester_rep",
    dict_kind
  )
  ...
  write_csv(long_trimesterly, paste(getwd(), "/", file_prefix, "_", dict_kind,
    "_", file_version, "_", file_name, ".csv",
    sep = ""
  ), na = "")
