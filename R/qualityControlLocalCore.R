...
lc.quality.local.core <- local(function(input_format = 'CSV', input_path, variable_category = 'ALL') {
  ...
  if(variable_category == 'ALL' || variable_category == 'META') lc.quality.local.core.meta(lc_data)
  if(variable_category == 'ALL' || variable_category == 'MATERNAL') lc.quality.local.core.maternal.social.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'MATERNAL') lc.quality.local.core.maternal.health.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'MATERNAL') lc.quality.local.core.maternal.lifestyle.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'MATERNAL') lc.quality.local.core.maternal.obstetric.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'PATERNAL') lc.quality.local.core.paternal.health.related.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'PATERNAL') lc.quality.local.core.paternal.lifestyle.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'PATERNAL') lc.quality.local.core.paternal.socio.demo.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'CHILD') lc.quality.local.core.child.birth.out(lc_data)
  if(variable_category == 'ALL' || variable_category == 'CHILD') lc.quality.local.core.child.exposure.lifestyle.environ.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'CHILD') lc.quality.local.core.child.exposure.lifestyle.environ.char(lc_data)
  if(variable_category == 'ALL' || variable_category == 'HOUSEHOLD') lc.quality.local.core.household.char(lc_data)
...
lc.quality.local.core.meta <- local(function(lc_data) {
  ...
  list(data_type=class(lifecyclelc_data$mother_id),
  ...
  list(data_type=class(lc_data$preg_no),
  ...
  list(data_type=class(lc_data$child_no),
  ...
  list(data_type=class(lc_data$recruit_age),
...
lc.quality.local.core.maternal.social.char <- local(function(lc_data) {
  ...
  # workaround to avoid glpobal variable warnings, check: https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
  child_id <- coh_country <- edu_m_0 <- edu_m_17 <- orig_var <- edu_m_ <- variable_trunc <- age_years <- prev <- edu_diff <- agebirth_m_d <- agebirth_m_y <- . <- .. <- NULL
  ...
  list(data_type=class(lc_data$cob_m),
  ...
  list(data_type=class(lc_data$ethn1_m),
  ...
  list(data_type=class(lc_data$ethn2_m),
  ...
  list(data_type=class(lc_data$ethn3_m),
  ...
  list(data_type=class(lc_data$agebirth_m_y),
  ...
  list(data_type=class(lc_data$death_m),
  ...
  list(data_type=class(lc_data$death_m_age),
...
lc.quality.local.core.maternal.health.char <- local(function(lc_data) {
  ...
  list(data_type=class(lc_data$prepreg_weight),
  ...
  list(data_type=class(lc_data$prepreg_weight_mes),
  ...
  list(data_type=class(lc_data$prepreg_weight_ga),
  ...
  list(data_type=class(lc_data$latepreg_weight),
       summary_stats=summarizeR(lc_data, "latepreg_weight")) 
  
  # * Check internal validity, e.g.:
  ggplotly(
    ggplot(lc_data, aes(latepreg_weight, preg_gain)) + 
      geom_point() + 
      theme_minimal()
  )
  ...
  # * Check for correct type [binary], number [two] and definition of categories [reported vs. measured weight; 0=Self-measured, 1=Measured]
  list(data_type=class(lc_data$latepreg_weight_mes),
  ...
  list(data_type=class(lc_data$preg_gain),
       summary_stats=summarizeR(lc_data, "preg_gain"))
  # and plot
  ggplotly(
    ggplot(lc_data, aes(y=preg_gain)) + geom_boxplot()
  )
  
  # * Check internal validity, e.g: 
  ggplotly(
    ggplot(lc_data, aes(latepreg_weight, prepreg_weight)) + 
      geom_point()
  )
  ...
  list(data_type=class(lc_data$preg_gain_mes),
  ...
  list(data_type=class(lc_data$height_m),
       summary_stats=summarizeR(lc_data, "height_m"))
  # and plot
  ggplotly(
    ggplot(lc_data, aes(y=height_m)) + geom_boxplot()
  )
  
  # * Check internal validity, e.g.:
  ggplotly(
    ggplot(lc_data, aes(height_m, prepreg_weight)) +
      geom_point() 
  )
  ...
  list(data_type=class(lc_data$height_mes_m),
  ...
  list(data_type=class(lc_data$prepreg_dia),
  ...
  list(data_type=class(lc_data$preg_dia),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$preg_thyroid),
  ...
  #  * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$preeclam),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$preg_ht),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$asthma_m),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$prepreg_psych),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$preg_psych),
  ...
  # * Check for correct type [binary], number [two] and definition of categories [0=No, 1=Yes]
  list(data_type=class(lc_data$ppd),
...
lc.quality.local.core.maternal.lifestyle.char <- local(function(lc_data) {
  ...
  list(data_type=class(lc_data$prepreg_smk),
  ...
  list(data_type=class(lc_data$prepreg_cig),
  ...
  list(data_type=class(lc_data$preg_smk),
  ...
  list(data_type=class(lc_data$preg_cig),
  ...
  list(data_type=class(lc_data$smk_t1),
  ...
  list(data_type=class(lc_data$smk_t2),
...
lc.quality.local.core.paternal.socio.demo.char <- local(function(lc_data) {
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  occup_f2_ <- c(which(names(lc_data) %in% "occup_f2_0") : which(names(lc_data) %in% "occup_f2_17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  occup_f2_fath <- c(which(names(lc_data) %in% "occup_f2_fath0") : which(names(lc_data) %in% "occup_f2_fath17"))
  ...
  occupcode_f1_ <- c(which(names(lc_data) %in% "occupcode_f1_0") : which(names(lc_data) %in% "occupcode_f1_17"))
  ...
  # * Check for correct type [categorical], number [four] and definition of categories [Type of father; 1=Biological father, 2=Social father, 3=Social mother, 4=Unknown]
  # * Also, check for correct number of time bands [eightteen, 0-17]
  occupcode_f1_fath <- c(which(names(lc_data) %in% "occupcode_f1_fath0") : which(names(lc_data) %in% "occupcode_f1_fath17"))
  ...
  # * Check for correct type [categorical], number [ten] and definition of categories [0-9]
  # * Also, check for correct number of time bands [eightteen, 0-17]
  occupcode_f2_ <- c(which(names(lc_data) %in% "occupcode_f2_0") : which(names(lc_data) %in% "occupcode_f2_17"))
  ...
  occupcode_f2_fath <- c(which(names(lc_data) %in% "occupcode_f2_fath0") : which(names(lc_data) %in% "occupcode_f2_fath17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  edu_f1_ <- c(which(names(lc_data) %in% "edu_f1_0") : which(names(lc_data) %in% "edu_f1_17"))
  ...
  # * Check for correct type [categorical], number [four] and definition of categories [Type of father; 1=Biological father, 2=Social father, 3=Social mother, 4=Unknown]
  # * Also, check for correct number of time bands [eightteen, 0-17]
  edu_f1_fath <- c(which(names(lc_data) %in% "edu_f1_fath0") : which(names(lc_data) %in% "edu_f1_fath17"))
  ...
  # * Check for correct type [categorical], number [three] and definition of categories [Level of education; 1=High, 2=Medium, 3=Low]
  # * Also, check for correct number of time bands [eightteen, 0-17]
  edu_f2_ <- c(which(names(lc_data) %in% "edu_f2_0") : which(names(lc_data) %in% "edu_f2_17"))
  ...
  # * Check for correct type [categorical], number [four] and definition of categories [Type of father; 1=Biological father, 2=Social father, 3=Social mother, 4=Unknown]
  # * Also, check for correct number of time bands [eightteen, 0-17]
  edu_f2_fath <- c(which(names(lc_data) %in% "edu_f2_fath0") : which(names(lc_data) %in% "edu_f2_fath17"))
...
lc.quality.local.core.child.birth.out <- local(function(lc_data) {
  ...
  ggplotly(
    lc_data %>% 
      ggplot(aes(y=birth_length,x=factor(outcome), col=factor(outcome))) +
      geom_boxplot() 
  )
...
lc.quality.local.core.child.health.related.char <- local(function(lc_data) {
  ...
  height_ <- c(which(names(lc_data) %in% "height_0") : which(names(lc_data) %in% "height_17"))
  ...
  height_age <- c(which(names(lc_data) %in% "height_age0") : which(names(lc_data) %in% "height_age215"))
  ...
  weight_ <- c(which(names(lc_data) %in% "weight_0") : which(names(lc_data) %in% "weight_215"))
  ...
  # * Please, check for outliers and impossible values [e.g. for height_age0 values must be within 0-29 (days)]
  # * Also, check for correct number of time bands [twohundredandsixteen, 0-215], where "0" is weight measured between the ages of 0 and <1 month
  weight_age <- c(which(names(lc_data) %in% "weight_age0") : which(names(lc_data) %in% "weight_age215"))
...
lc.quality.local.core.child.exposure.lifestyle.environ.char <- local(function(lc_data) {
  ...
  childcare_ <- c(which(names(lc_data) %in% "childcare_0") : which(names(lc_data) %in% "childcare_3"))
  ...
  childcarerel_ <- c(which(names(lc_data) %in% "childcarerel_0") : which(names(lc_data) %in% "childcarerel_3"))
  ...
  # * Also, check for correct number of time bands [four, 0-3], where "0" is within 1st year of life, and "1" is within 2nd year of life
  childcareprof_ <- c(which(names(lc_data) %in% "childcareprof_0") : which(names(lc_data) %in% "childcarerel_3"))
  ...
  # * Also, check for correct number of time bands [four, 0-3], where "0" is within 1st year of life, and "1" is within 2nd year of life
  childcarecentre_ <- c(which(names(lc_data) %in% "childcarecentre_0") : which(names(lc_data) %in% "childcarecentre_3"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  smk_exp <- c(which(names(lc_data) %in% "smk_exp0") : which(names(lc_data) %in% "smk_exp17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  pets_ <- c(which(names(lc_data) %in% "pets_0") : which(names(lc_data) %in% "pets_17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  mental_exp <- c(which(names(lc_data) %in% "mental_exp0") : which(names(lc_data) %in% "mental_exp17"))
...
lc.quality.local.core.household.char <- local(function(lc_data) {
  ...
  # * Also, Check for correct number of time bands [eightteen, 0-17]
  hhincome_ <- c(which(names(lc_data) %in% "hhincome_0") : which(names(lc_data) %in% "hhincome_17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  fam_splitup <- c(which(names(lc_data) %in% "fam_splitup0") : which(names(lc_data) %in% "fam_splitup17"))
  ...
  # * Also, check for correct number of time bands [eightteen, 0-17]
  famsize_child <- c(which(names(lc_data) %in% "famsize_child0") : which(names(lc_data) %in% "famsize_child17"))
  ...
  # * Check for outliers and impossible values (e.g. substantial high values, of children)
  # * Also, check for correct number of time bands [eightteen, 0-17]
  famsize_adult <- c(which(names(lc_data) %in% "famsize_adult0") : which(names(lc_data) %in% "famsize_adult17"))
