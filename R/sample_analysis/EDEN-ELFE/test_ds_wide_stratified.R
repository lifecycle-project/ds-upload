...
## Create an overweight variable from the data and the cutoffs table:
...
for(i in array){
  ...
  initial_var <- paste("D_girls$BMI_", i, sep = "")
  ...
  ds.cbind(c(dest_var, 'D_girls'), newobj = 'D_girls')
  
}

ds.summary('overweight_85')

##### Remove NA in the overweight variables or the vector sum won't compute:
...
for(i in array){
  ...
  if(ds.class(paste("D_girls$", var_name, sep = "")) != "NULL"){
    
    # Remove the NAs by putting 0s in their place
    
    ds.recodeValues.o(paste('D_girls$', var_name, sep = ''), c(1,NA), c(1,0), var_name)
  } else {
...
ds.cbind(c('overweight_n', 'D_girls'), newobj = 'D_girls')
...
ds.summary('D_girls$overweight_n')

#### Regression model: Girls #####
...
for(i in array){
  ...
  initial_var <- paste("D_boys$BMI_", i, sep = "")
  ...
  ds.cbind(c(dest_var, 'D_boys'), newobj = 'D_boys')
...
for(i in array){
  ...
  if(ds.class(paste("D_boys$", var_name, sep = "")) != "NULL"){
    
    # Remove the NAs by putting 0s in their place
    
    ds.recodeValues.o(paste('D_boys$', var_name, sep = ''), c(1,NA), c(1,0), var_name)
  } else {
...
ds.vectorCalc(x=array, calc = '+', newobj = "overweight")
ds.Boole.o(V1 = "overweight", V2 = "0" , Boolean.operator = '>', newobj = "overweight_n")
ds.cbind(c('overweight_n', 'D_boys'), newobj = 'D_boys')
...
ds.summary('D_boys$overweight_n')

#### Regression model: Boys #####
