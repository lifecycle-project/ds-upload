...
#'
#' @noRd
du.reshape.wide.generate.non.repeated <- function(data, dict_kind) {
...
#'
#' @noRd
du.reshape.wide.generate.yearly.repeated <- function(data, dict_kind) {
...
#'
#' @noRd
du.reshape.wide.generate.monthly.repeated <- function(data, dict_kind) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
...
#'
#' @noRd
du.reshape.wide.generate.weekly.repeated <- function(data, dict_kind) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
...
#'
#' @noRd
du.reshape.wide.generate.trimesterly.repeated <- function(data, dict_kind) {
  # workaround to avoid glpobal variable warnings, check:
  # https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when
