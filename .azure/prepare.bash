...
Rscript -e "install.packages(c('opalr', 'MolgenisArmadillo', 'maditr', 'DSI', 'DSOpal', 'DSMolgenisArmadillo', 'dsBaseClient', 'dsHelper'), repos=c('https://cloud.r-project.org', 'https://registry.molgenis.org/repository/r-hosted-external/'), lib='${R_LIBS_USER}')"
