...
library(dplyr)
# First we need to login to the Armadillo 3 server
?MolgenisArmadillo::armadillo.login

MolgenisArmadillo::armadillo.login(
  armadillo = "https://armadillo-demo.molgenis.net")
...
tri_rep <- MolgenisArmadillo::armadillo.load_table("inma","1_0_outcome_ath_1_0","trimester_rep")
...
MolgenisArmadillo::armadillo.upload_table(subset_name,"1_0_outcome_ath_1_0",subset_tri_rep,"trimester_rep")