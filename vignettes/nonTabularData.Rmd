...
#> Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file 'https://github.com/isglobal-brge/methylclock/raw/master/inst/
#> extdata/SampleAnnotationExample55.csv?raw=true', probable reason 'No such file or directory'
