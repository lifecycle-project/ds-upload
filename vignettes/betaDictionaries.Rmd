...
#> * Create table: [ example-dictionary-non_rep ]
...
#> * Upload: [ 2020-11-02_12-05-26_example-dictionary-non_rep.csv ] to directory [ beta ]
#> ######################################################
#>   Reshaping successfully finished
#> ######################################################
#>   Starting quality control
#> ------------------------------------------------------
#>  * Starting with: lc_beta_example-dictionary - example-dictionary-non_rep
#> 
#> Logging into the collaborating servers
#> Error in getClass(Class, where = topenv(parent.frame())): "OpalDriver" is not a defined class
