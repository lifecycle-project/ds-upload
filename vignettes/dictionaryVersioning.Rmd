...
You can add new content and release the dictionaries for the network.
...
### Dictionary
We are using semantic versioning in the data dictionary in the network. The implementation we now use is:
