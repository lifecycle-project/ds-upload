...
- [Armadillo](https://molgenis.github.io/molgenis/molgenis-r-datashield)
...
du.upload(
  ...
  data_input_path = 'https://github.com/lifecycle-project/analysis-protocols/blob/master/tests/data/WP1/data/all_measurements_v1_2.csv?raw=true',
...
du.upload(
  ...
  data_version = '1_0', 
  data_input_format = 'CSV',
  data_input_path = 'https://github.com/lifecycle-project/analysis-protocols/blob/master/tests/data/WP6/nd_data_wp6.csv?raw=true',
  non_interactive = TRUE
)
```
