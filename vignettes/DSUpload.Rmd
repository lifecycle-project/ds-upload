...
#> installing the source package 'dsUpload'
```
...
#> * Create table: [ 2_1_core_1_0_monthly_rep ]
#> * Import variables into: [ 2_1_core_1_0_monthly_rep ]
#> * Create table: [ 2_1_core_1_0_non_rep ]
#> * Matched categories for table: [ 2_1_core_1_0_non_rep ]
#> * Import variables into: [ 2_1_core_1_0_non_rep ]
#> * Create table: [ 2_1_core_1_0_trimester_rep ]
#> * Matched categories for table: [ 2_1_core_1_0_trimester_rep ]
#> * Import variables into: [ 2_1_core_1_0_trimester_rep ]
#> * Create table: [ 2_1_core_1_0_yearly_rep ]
#> * Matched categories for table: [ 2_1_core_1_0_yearly_rep ]
#> * Import variables into: [ 2_1_core_1_0_yearly_rep ]
#>   All dictionaries are populated correctly
#> ######################################################
#>   Importing data dictionaries has finished
#> ######################################################
#> ######################################################
...
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/MEXVAUEQIHDRWII/2020-09-17_09-00-21_core_1_0_non_repeated_measures.csv
#> * Generating: yearly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/MEXVAUEQIHDRWII/2020-09-17_09-00-21_core_1_0_yearly_repeated_measures.csv
#> * Generating: monthly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/MEXVAUEQIHDRWII/2020-09-17_09-00-21_core_1_0_monthly_repeated_measures.csv
#> * Generating: trimesterly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/MEXVAUEQIHDRWII/2020-09-17_09-00-21_core_1_0_trimester_repeated_measures.csv
#> ######################################################
...
#> ------------------------------------------------------
#>   Start importing dictionaries
#> * Create table: [ 1_1_outcome_1_0_monthly_rep ]
#> * Matched categories for table: [ 1_1_outcome_1_0_monthly_rep ]
#> * Import variables into: [ 1_1_outcome_1_0_monthly_rep ]
#> * Create table: [ 1_1_outcome_1_0_non_rep ]
#> * Matched categories for table: [ 1_1_outcome_1_0_non_rep ]
#> * Import variables into: [ 1_1_outcome_1_0_non_rep ]
#> * Create table: [ 1_1_outcome_1_0_weekly_rep ]
#> * Import variables into: [ 1_1_outcome_1_0_weekly_rep ]
#> * Create table: [ 1_1_outcome_1_0_yearly_rep ]
#> * Matched categories for table: [ 1_1_outcome_1_0_yearly_rep ]
#> * Import variables into: [ 1_1_outcome_1_0_yearly_rep ]
#>   All dictionaries are populated correctly
#> ######################################################
#>   Importing data dictionaries has finished
#> ######################################################
...
#> ------------------------------------------------------
#> * Generating: non-repeated measures
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/CVTROQVOPZEFVGZ/2020-09-17_09-00-42_outcome_1_0_non_repeated_measures.csv
#> * Generating: yearly-repeated measures
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/CVTROQVOPZEFVGZ/2020-09-17_09-00-42_outcome_1_0_yearly_repeated_measures.csv
#> * Generating: monthly-repeated measures
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/CVTROQVOPZEFVGZ/2020-09-17_09-00-42_outcome_1_0_monthly_repeated_measures.csv
#> * Generating: weekly-repeated measures
#> * Upload: /Users/sido/RProjects/ds-upload/vignettes/CVTROQVOPZEFVGZ/2020-09-17_09-00-42_outcome_1_0_weekly_repeated_measures.csv
#> ######################################################
#>   Reshaping successfully finished
#> ######################################################
#>  * Reinstate default working directory
