...
#> * Create table: [ 1_0_monthly ]
#> * Import variables into: [ 1_0_monthly ]
#> * Create table: [ 1_0_non ]
#> * Matched categories for table: [ 1_0_non ]
#> * Import variables into: [ 1_0_non ]
#> * Create table: [ 1_0_trimester ]
#> * Matched categories for table: [ 1_0_trimester ]
#> * Import variables into: [ 1_0_trimester ]
#> * Create table: [ 1_0_yearly ]
#> * Matched categories for table: [ 1_0_yearly ]
#> * Import variables into: [ 1_0_yearly ]
...
#> * Upload: [ 2020-10-20_21-24-03_1_0_non_repeated_measures.csv ] to directory [ core ]
#> * Generating: yearly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_21-24-03_1_0_yearly_repeated_measures.csv ] to directory [ core ]
#> * Generating: monthly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_21-24-03_1_0_monthly_repeated_measures.csv ] to directory [ core ]
#> * Generating: trimesterly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_21-24-03_1_0_trimester_repeated_measures.csv ] to directory [ core ]
#> ######################################################
...
#>   Start importing dictionaries
#> * Create table: [ 1_0_monthly ]
#> * Matched categories for table: [ 1_0_monthly ]
#> * Import variables into: [ 1_0_monthly ]
#> * Create table: [ 1_0_non ]
#> * Matched categories for table: [ 1_0_non ]
#> * Import variables into: [ 1_0_non ]
#> * Create table: [ 1_0_weekly ]
#> * Import variables into: [ 1_0_weekly ]
#> * Create table: [ 1_0_yearly ]
#> * Matched categories for table: [ 1_0_yearly ]
#> * Import variables into: [ 1_0_yearly ]
#>   All dictionaries are populated correctly
...
#> See spec(...) for full column specifications.
#> * Generating: non-repeated measures
#> * Upload: [ 2020-10-20_21-24-34_1_0_non_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: yearly-repeated measures
#> * Upload: [ 2020-10-20_21-24-34_1_0_yearly_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: monthly-repeated measures
#> * Upload: [ 2020-10-20_21-24-34_1_0_monthly_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: weekly-repeated measures
#> * Upload: [ 2020-10-20_21-24-34_1_0_weekly_repeated_measures.csv ] to directory [ outcome ]
#> ######################################################
#>   Reshaping successfully finished
#> ######################################################
#>  * Reinstate default working directory
