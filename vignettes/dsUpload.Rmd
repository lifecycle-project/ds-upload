...
#>   Login to: "https://armadillo.dev.molgenis.org"
#> [1] "We're opening a browser so you can log in with code 2FB2ST"
#>   Logged on to: "https://armadillo.dev.molgenis.org"
```
...
#> Aggregate function missing, defaulting to 'length'
#> * Start importing: 2_1_core_1_0 into project: dnbc
#> Compressing...
#>   |                                                                                         |                                                                                 |   0%  |                                                                                         |=================================================================================| 100%
...
#> * Start importing: 1_1_outcome_1_0 into project: dnbc
#> Compressing...
#>   |                                                                                         |                                                                                 |   0%  |                                                                                         |=================================================================================| 100%
...
#> * Project: [ lc_dnbc_core_2_1 ] already exists
#> ------------------------------------------------------
...
#> * Create table: [ 1_0_trimester_rep ]
...
#> * Generating: trimesterly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-11-04_21-29-14_1_0_trimester_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-11-04_21-29-14_1_0_non_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-11-04_21-29-14_1_0_yearly_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-11-04_21-29-14_1_0_monthly_repeated_measures.csv ] to directory [ core ]
#> ######################################################
#>   Converting and import successfully finished
#> ######################################################
#>  * Reinstate default working directory
...
#> * Project: [ lc_dnbc_outcome_1_1 ] already exists
#> ------------------------------------------------------
#>   Start importing dictionaries
...
#> * Generating: monthly-repeated measures
#> * Generating: weekly-repeated measures
#> * Upload: [ 2020-11-04_21-29-43_1_0_weekly_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-11-04_21-29-43_1_0_non_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-11-04_21-29-43_1_0_yearly_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-11-04_21-29-43_1_0_monthly_repeated_measures.csv ] to directory [ outcome ]
#> ######################################################
#>   Converting and import successfully finished
#> ######################################################
#>  * Reinstate default working directory
