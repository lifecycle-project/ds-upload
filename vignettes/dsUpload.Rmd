...
#> [1] "We're opening a browser so you can log in with code 2696NM"
...
#> ------------------------------------------------------
#> Error in tables$name: $ operator is invalid for atomic vectors
...
#> * Generating: trimesterly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-12-02_15-29-42_1_0_trimester_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-12-02_15-29-42_1_0_non_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-12-02_15-29-42_1_0_yearly_repeated_measures.csv ] to directory [ core ]
#> * Upload: [ 2020-12-02_15-29-42_1_0_monthly_repeated_measures.csv ] to directory [ core ]
#> ######################################################
#>   Converting and import successfully finished
#> ######################################################
```
...
#> * Generating: monthly-repeated measures
#> * Generating: weekly-repeated measures
#> * Upload: [ 2020-12-02_15-31-57_1_0_weekly_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-12-02_15-31-57_1_0_non_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-12-02_15-31-57_1_0_yearly_repeated_measures.csv ] to directory [ outcome ]
#> * Upload: [ 2020-12-02_15-31-57_1_0_monthly_repeated_measures.csv ] to directory [ outcome ]
#> ######################################################
#>   Converting and import successfully finished
#> ######################################################
```
