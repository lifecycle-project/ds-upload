...
#> * Upload: [ 2020-10-20_23-10-24_1_0_non_repeated_measures.csv ] to directory [ core ]
#> * Generating: yearly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_23-10-24_1_0_yearly_repeated_measures.csv ] to directory [ core ]
#> * Generating: monthly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_23-10-24_1_0_monthly_repeated_measures.csv ] to directory [ core ]
#> * Generating: trimesterly-repeated measures
#> Aggregate function missing, defaulting to 'length'
#> * Upload: [ 2020-10-20_23-10-24_1_0_trimester_repeated_measures.csv ] to directory [ core ]
#> ######################################################
...
#> See spec(...) for full column specifications.
#> * Generating: non-repeated measures
#> * Upload: [ 2020-10-20_23-10-56_1_0_non_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: yearly-repeated measures
#> * Upload: [ 2020-10-20_23-10-56_1_0_yearly_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: monthly-repeated measures
#> * Upload: [ 2020-10-20_23-10-56_1_0_monthly_repeated_measures.csv ] to directory [ outcome ]
#> * Generating: weekly-repeated measures
#> * Upload: [ 2020-10-20_23-10-56_1_0_weekly_repeated_measures.csv ] to directory [ outcome ]
#> ######################################################
#>   Reshaping successfully finished
#> ######################################################
#>  * Reinstate default working directory
